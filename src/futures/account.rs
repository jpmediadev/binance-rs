...
impl FuturesAccount {
    ...
    // Modify Order
    pub fn modify_order<S,F>(&self, symbol: S, side: OrderSide, price: f64, quantity: f64, client_order_id: S, is_close_position: bool) -> Result<Transaction>
     where
        S: Into<String>,
    {
        let mut parameters = BTreeMap::new();
    ...
    pub fn get_all_orders<S>(&self, symbol: S, limit: usize) -> Result<Vec<crate::futures::model::Order>>
    where
        S: Into<String>,
    {
        let mut parameters: BTreeMap<String, String> = BTreeMap::new();
    ...
    pub fn get_order_status<S>(&self, symbol: S, client_order_id: S) -> Result<crate::futures::model::Order>
    where
        S: Into<String>,
    {
        let mut parameters: BTreeMap<String, String> = BTreeMap::new();
